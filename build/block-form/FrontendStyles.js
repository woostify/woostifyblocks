...
function handleSubmitForm(formId, props) {
  ...
  if (reCaptchaV2) {
    $(`#${formId} .g-recaptcha`).attr("data-sitekey", ___WEBPACK_IMPORTED_MODULE_4__.DEMO_WCB_GLOBAL_VARIABLES.reCAPTCHA_v2_site_key || "");
  }
  $("#" + formId).on("submit", function (event) {
    ...
    if (typeof grecaptcha === "object" && reCaptchaV3) {
      grecaptcha.ready(function () {
        grecaptcha.execute(___WEBPACK_IMPORTED_MODULE_4__.DEMO_WCB_GLOBAL_VARIABLES.reCAPTCHA_v3_site_key, {
          action: "submit"
        }).then(function (token) {
          console.log(123, {
            token,
            key: ___WEBPACK_IMPORTED_MODULE_4__.DEMO_WCB_GLOBAL_VARIABLES.reCAPTCHA_v3_site_key
          });
          handleAjaxAction();
        });
      });
