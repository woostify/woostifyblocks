...
const SettingsPageBlockSettings = ({
  ...
  const debounce_fun = lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(function (data) {
...
const SettingsPageTemplates = ({
  ...
  const debounce_fun = lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default()(function (data) {
    console.log("Function debounced after 300ms!", {
      data
    });
    onChange(data);
