...
/* harmony import */ var _components_controls_button_popover__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../components/controls/button-popover */ "./src/components/controls/button-popover/index.js");
/* harmony import */ var _components_controls_font_family_picker__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../components/controls/font-family-picker */ "./src/components/controls/font-family-picker/index.js");
/* harmony import */ var _components_controls_typography__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../components/controls/typography */ "./src/components/controls/typography/index.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/first-block/editor.scss");
...
function Edit(props) {
  ...
  const [columns, setColumns] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(2);
  const {
    attributes,
    setAttributes,
    clientId
  ...
  let lineHeightCSS = attributes['lineHeight' + getDeviceSuffix()] + attributes['lineHeightUnit' + getDeviceSuffix()];
  let fontSizeCSS = attributes['fontSize' + getDeviceSuffix()] + attributes['fontSizeUnit' + getDeviceSuffix()];
  let letterSpacingCSS = attributes['letterSpacing' + getDeviceSuffix()] + 'px';
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
  ...
  }, tab => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, null, 'normal' === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_controls_base__WEBPACK_IMPORTED_MODULE_8__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Background Color', 'woostify-block'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Vestibulum ullamcorper mauris at ligula', 'woostify-block'),
    units: ['px', 'rem', '%'],
    responsive: ['desktop', 'tablet', 'mobile'],
    ...
    onChange: value => setColumns(value),
    max: 10
  })), 'active' === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_controls_base__WEBPACK_IMPORTED_MODULE_8__["default"], {
  ...
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_controls_button_popover__WEBPACK_IMPORTED_MODULE_10__["default"], {
    popoverHeading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Typography', 'woostify-block')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_controls_typography__WEBPACK_IMPORTED_MODULE_12__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
  ...
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_controls_base__WEBPACK_IMPORTED_MODULE_8__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
    ...
    disableInputs: ['marginLeft' + getDeviceSuffix(), 'marginRight' + getDeviceSuffix()]
...
class WoostifyBaseControl extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  handleOnClickOutside(ev) {
    ...
    if (this.state.isOpenResponsiveToggle) {
      ...
      const closest = (_ev$target = ev.target) === null || _ev$target === void 0 ? void 0 : _ev$target.closest('.wb-base-control-responsive-toggle');
  ...
  render() {
    ...
    const toggleBtnClassName = classNames('wb-base-control-responsive-toggle', {
      'is-open': this.state.isOpenResponsiveToggle
    });
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      style: {
        transform: `translateY( ${getResponsiveToggleOffset()}%)`
      }
    }, responsive.map((v, i) => {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        onClick: () => {
          if (!this.state.isOpenResponsiveToggle) {
            this.setState({
              isOpenResponsiveToggle: true
            });
          } else {
            onResponsiveToggleClick(this.capitalizeFirstLetter(v));
            this.setState({
              isOpenResponsiveToggle: false,
              selectedDevice: this.capitalizeFirstLetter(v)
            });
          }
        }
        ...
        icon: device
      })), tooltip && this.state.isMouseHover === v && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
...
class WoostifyTypographyControl extends _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(props) {
    super(...arguments);
    this.state = {
      selectedFontWeight: '',
  ...
  render() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_font_family_picker__WEBPACK_IMPORTED_MODULE_4__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.props, {
      ...
      selectedUnit: attributes[attrFontSizeUnit + this.getDeviceSuffix()],
      onResponsiveToggleClick: device => setDeviceType(device),
      onUnitClick: unit => {
        setAttributes({
      ...
      value: this.state['selectedFontSize' + this.getDeviceSuffix()] || attributes[attrFontSize + this.getDeviceSuffix()],
      min: 0,
      onChange: val => {
        this.setState({
          ['selectedFontSize' + this.getDeviceSuffix()]: val
        });
        setAttributes({
      ...
      value: this.state.selectedFontWeight || attributes[attrFontWeight],
      ...
      value: this.state.selectedFontStyle || attributes[attrFontStyle],
      ...
      selectedDevice: deviceType,
      selectedUnit: attributes[attrLineHeightUnit + this.getDeviceSuffix()],
      onResponsiveToggleClick: device => setDeviceType(device),
      onUnitClick: unit => {
        console.log(unit);
        setAttributes({
      ...
      value: this.state['selectedLineHeight' + this.getDeviceSuffix()] || attributes[attrLineHeight + this.getDeviceSuffix()],
      min: 0,
      onChange: val => {
        this.setState({
          ['selectedLineHeight' + this.getDeviceSuffix()]: val
        });
        setAttributes({
      ...
      value: this.state['selectedLetterSpacing' + this.getDeviceSuffix()] || attributes[attrLetterSpacing + this.getDeviceSuffix()],
      min: 0,
      onChange: val => {
        this.setState({
          ['selectedLetterSpacing' + this.getDeviceSuffix()]: val
        });
        setAttributes({
          [attrLetterSpacing + this.getDeviceSuffix()]: val
        });
      },
      max: 100,
      step: 0.1,
