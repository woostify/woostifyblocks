      ...
      [POST_CARD_CLASS]: {
        ...
        ":hover": {
          ".wcb-products__product--quickViewBottomImage--item": {
            ...
            gap: "6px !important",
            position: "absolute",
            bottom: style_quickViewBtn?.position === "bottom-image" ? "10px !important" : style_quickViewBtn?.position === "center-image" ? "6rem" : "auto",
            ...
            right: style_quickViewBtn?.position === "bottom-image" ? "0 !important" : style_quickViewBtn?.position === "center-image" ? "50%" : style_quickViewBtn?.position === "top-right" ? "0px" : "auto",
            width: style_quickViewBtn?.position === "bottom-image" ? "100%" : style_quickViewBtn?.position === "center-image" ? "auto" : style_quickViewBtn?.position === "top-right" ? "2.48rem" : "unset",
        ...
        "&.wcb-products__product--wishlistTopRight:hover": {
          ".wcb-products__product--wishlistTopRight--item": {
            ...
            top: general_addToCartBtn?.position === "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position !== "top-right" ? "0" : general_addToCartBtn?.position === "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position === "top-right" ? "2.48rem" : general_addToCartBtn?.position !== "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position === "top-right" ? "0" : "-2.5rem",
            right: 0,
            width: "2.5rem",
            height: "2.5rem",
            display: "flex",
...
function buildStyleQuickViewButtonDefault(attr) {
  var _ref37, _quickViewBtn$enabled, _ref38, _quickViewBtn$positio, _ref39, _quickViewBtn$show_ic, _ref40, _quickViewBtn$bg_colo, _ref41, _quickViewBtn$text_co, _ref42, _quickViewBtn$hover_b, _ref43, _quickViewBtn$hover_t, _ref44, _quickViewBtn$border_;
  const theme = (0,_utils_themeDefaults__WEBPACK_IMPORTED_MODULE_2__.getThemeDefaults)();
...
function mergeProductAttrsWithThemeDefaults(attr) {
  ...
  return {
    ...
    style_quickViewBtn: buildStyleQuickViewButtonDefault(base.style_quickViewBtn)
  };
}
