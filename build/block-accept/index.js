...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"wcb/accept","version":"0.1.0","title":"Accept","parent":["wcb/form"],"category":"wcb-blocks","icon":"- wcb-block-editor-block-icon lni lni-checkmark-circle","description":"Example static block scaffolded with Create Block tool.","supports":{"__experimentalSelector":"span,label"},"textdomain":"wcb-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
