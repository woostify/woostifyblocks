<<<<<<< HEAD
(()=>{"use strict";var r,e={796:()=>{const r=window.wp.blocks,e=JSON.parse('{"UU":"create-block-wcbxxyyyzz/wcbxxyyyzz-blocks-common-css"}'),o=window.React;(0,r.registerBlockType)(e.UU,{edit:()=>(0,o.createElement)("div",null,"Edit"),save:()=>null,attributes:[]})}},o={};function t(r){var s=o[r];if(void 0!==s)return s.exports;var i=o[r]={exports:{}};return e[r](i,i.exports,t),i.exports}t.m=e,r=[],t.O=(e,o,s,i)=>{if(!o){var l=1/0;for(v=0;v<r.length;v++){for(var[o,s,i]=r[v],n=!0,a=0;a<o.length;a++)(!1&i||l>=i)&&Object.keys(t.O).every((r=>t.O[r](o[a])))?o.splice(a--,1):(n=!1,i<l&&(l=i));if(n){r.splice(v--,1);var c=s();void 0!==c&&(e=c)}}return e}i=i||0;for(var v=r.length;v>0&&r[v-1][2]>i;v--)r[v]=r[v-1];r[v]=[o,s,i]},t.o=(r,e)=>Object.prototype.hasOwnProperty.call(r,e),(()=>{var r={3627:0,3091:0};t.O.j=e=>0===r[e];var e=(e,o)=>{var s,i,[l,n,a]=o,c=0;if(l.some((e=>0!==r[e]))){for(s in n)t.o(n,s)&&(t.m[s]=n[s]);if(a)var v=a(t)}for(e&&e(o);c<l.length;c++)i=l[c],t.o(r,i)&&r[i]&&r[i][0](),r[i]=0;return t.O(v)},o=globalThis.webpackChunkwoostifyblocks=globalThis.webpackChunkwoostifyblocks||[];o.forEach(e.bind(null,0)),o.push=e.bind(null,o.push.bind(o))})();var s=t.O(void 0,[3091],(()=>t(796)));s=t.O(s)})();
=======
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
