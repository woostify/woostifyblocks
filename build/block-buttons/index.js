...
const GlobalCss = attrs => {
  ...
  const INNER_BUTTON_TEXT = `#${uniqueId} .wcb-button__text`; // ------------------- WRAP DIV
...
const WCB_BUTTONS_PANEL_STYLE_DIMENSION_DEMO = { ..._components_controls_MyDimensionsControl_types__WEBPACK_IMPORTED_MODULE_5__.MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
  padding: {
    Desktop: {
      top: "10px",
      left: "24px",
