/******/ (function () {
  ...
  \**********************************************/
			/***/ function (
				...
				/* harmony import */ var _wordpress_api__WEBPACK_IMPORTED_MODULE_5__ =
					__webpack_require__(/*! @wordpress/api */ '@wordpress/api');
				/* harmony import */ var _wordpress_api__WEBPACK_IMPORTED_MODULE_5___default =
					/*#__PURE__*/ __webpack_require__.n(
						_wordpress_api__WEBPACK_IMPORTED_MODULE_5__
					);
				/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(/*! lodash */ 'lodash');
				/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_6___default =
					/*#__PURE__*/ __webpack_require__.n(
						lodash__WEBPACK_IMPORTED_MODULE_6__
					);
				/* harmony import */ var _typo_picker__WEBPACK_IMPORTED_MODULE_7__ =
					__webpack_require__(
						/*! ./typo/picker */ './src/plugins/global-settings/typo/picker.js'
					);

				const sidebarName = 'woostify-block-sidebar';

				const sidebarTitle = (0,
				_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(
					'Woostify Block Settings',
					'woostify-block'
				);
				...
				const WoostifyBlockSidebarContent = (props) => {
					const [typoSettings, setTypoSettings] = (0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(
						[]
					);
					const TYPO_LIST = [
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
						// Get settings.
						_wordpress_api__WEBPACK_IMPORTED_MODULE_5__.loadPromise.then(
							() => {
								const settings =
									new _wordpress_api__WEBPACK_IMPORTED_MODULE_5__.models.Settings();
								settings.fetch().then((response) => {
									setTypoSettings(
										(0,
										lodash__WEBPACK_IMPORTED_MODULE_6__.head)(
											response.wcb_global_typography
										) || {}
									);
								});
							}
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							...
							TYPO_LIST.map((_ref, index) => {
								let { label, tag } = _ref;
								return (0,
								_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
									_typo_picker__WEBPACK_IMPORTED_MODULE_7__[
										'default'
									],
									{
										label: label,
				...
				const WoostifyBlockPluginSidebar = () => {
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						(0,
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_3__.PluginSidebarMoreMenuItem,
							{
								target: sidebarName,
								icon: sidebarIcon,
							},
				...
				(0,
				_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)(
					sidebarName,
					{
		...
		/***/ './src/plugins/global-settings/typo/picker.js':
			/*!****************************************************!*\
  !*** ./src/plugins/global-settings/typo/picker.js ***!
  \****************************************************/
			/***/ function (
				...
				/* harmony import */ var _components_controls_button_popover__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ../../../components/controls/button-popover */ './src/components/controls/button-popover/index.js'
					);
				/* harmony import */ var _components_controls_typography__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ../../../components/controls/typography */ './src/components/controls/typography/index.js'
					);

				const WCBTypoPicker = (props) => {
					const { value } = props; // On style change, gather all the styles then trigger the onChange.

					const handleOnChangeSetting = (style, value) => {
						const newStyles = { ...props.value, [style]: value };
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						(0,
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							_components_controls_button_popover__WEBPACK_IMPORTED_MODULE_2__[
								'default'
							],
							{
							...
							(0,
							_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
								_components_controls_typography__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								],
								{
									...
									fontSizeUnitTablet:
										value.fontSizeUnitTablet,
									fontSizeUnitMobile:
										value.fontSizeUnitMobile,
									...
									lineHeightUnitTablet:
										value.lineHeightUnitTablet,
									lineHeightUnitMobile:
										value.lineHeightUnitMobile,
...
*/
  ...
  \************************/
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ var _plugins_global_settings__WEBPACK_IMPORTED_MODULE_0__ =
			__webpack_require__(
				/*! ./plugins/global-settings */ './src/plugins/global-settings/index.js'
			);
	})();
	/******/
})();
