		...
		return (
			<>
				<div className="wb-dimensions-control-inputs">
					...
					/>
					<Tooltip text={__("Link values together", "wcb")}>
						<Button
							isSmall
				...
				<div className="wb-dimensions-control-labels">
					<span className="wb-dimensions-control-input-label">{labelTop}</span>
					...
					<span className="wb-dimensions-control-input-label">{labelLeft}</span>
