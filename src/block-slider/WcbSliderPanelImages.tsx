...
export interface WCB_SLIDER_PANEL_IMAGES {
...
export const WCB_SLIDER_PANEL_IMAGES_DEMO: WCB_SLIDER_PANEL_IMAGES =
	{
		images: [],
		imageSize: "thumbnail",
		isShowImage: true,
...
interface Props
	...
	panelData: WCB_SLIDER_PANEL_IMAGES;
	setAttr__: (data: WCB_SLIDER_PANEL_IMAGES) => void;
...
const WcbTestimonialsPanelImages: FC<Props> = ({
	...
	const renderSettingsImage = () => {
		const POSTION_PLANS: MyRadioItem<
			WCB_SLIDER_PANEL_IMAGES["imagePosition"]
		>[] = [
			{ name: "top", icon: "Top" },
			{ name: "left", icon: "Left" },
