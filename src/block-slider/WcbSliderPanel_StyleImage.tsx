...
export interface WCB_SLIDER_PANEL_STYLE_IMAGE {
	padding: HasResponsive<DimensionSettings>;
	imageSize: HasResponsive<string>;
	radius: HasResponsive<BorderRadiusSettings>;
	objectFit: CSSProperties["objectFit"];
}
export const WCB_SLIDER_PANEL_STYLE_IMAGE_DEMO: WCB_SLIDER_PANEL_STYLE_IMAGE =
	{
		padding: {
			Desktop: {
				top: "1rem",
...
interface Props
	...
	panelData: WCB_SLIDER_PANEL_STYLE_IMAGE;
	setAttr__: (data: WCB_SLIDER_PANEL_STYLE_IMAGE) => void;
}
...
const WcbTestimonialsPanel_StyleImage: FC<Props> = ({
	...
	const OBJECT_FIT_DEMO: Option<
		WCB_SLIDER_PANEL_STYLE_IMAGE["objectFit"]
	>[] = [
				...
				<MySelect
					...
					onChange={(value) => {
						setAttr__({
							...panelData,
							objectFit:
								value as WCB_SLIDER_PANEL_STYLE_IMAGE["objectFit"],
						});
					}}
				/>
