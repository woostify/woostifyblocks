...
export interface WCB_COUNTDOWN_PANEL_ICON {
	enableIcon: boolean;
	icon: MyIcon;
	iconPosition:
		| "top"
...
export const WCB_COUNTDOWN_PANEL_ICON_DEMO: WCB_COUNTDOWN_PANEL_ICON = {
	enableIcon: true,
	iconPosition: "top",
	stackOn: "none",
...
interface Props
	...
	panelData: WCB_COUNTDOWN_PANEL_ICON;
	setAttr__: (data: WCB_COUNTDOWN_PANEL_ICON) => void;
}

const WcbIconBoxPanelIcon: FC<Props> = ({
	panelData = WCB_COUNTDOWN_PANEL_ICON_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
	...
	const { enableIcon, icon, iconPosition, stackOn, verticalAlignment } =
		panelData;
	//
	const PLANS_DEMO: Option<WCB_COUNTDOWN_PANEL_ICON["iconPosition"]>[] = [
		{ value: "top", label: "Top" },
	...
	const STACK_ON_DEMO: Option<WCB_COUNTDOWN_PANEL_ICON["stackOn"]>[] = [
		{ value: "none", label: "None" },
		{ value: "tablet", label: "Tablet" },
		{ value: "mobile", label: "Mobile" },
	];
	const VERTICAL_DEMO: Option<WCB_COUNTDOWN_PANEL_ICON["verticalAlignment"]>[] =
		[
			{ value: "top", label: "Top" },
				...
				{enableIcon && (
					<>
						...
						<MySelect
							...
							value={iconPosition}
							onChange={(value) => {
								let newData: WCB_COUNTDOWN_PANEL_ICON = {
									...panelData,
									iconPosition:
										value as WCB_COUNTDOWN_PANEL_ICON["iconPosition"],
								};
						...
						{(iconPosition === "left" || iconPosition === "right") && (
							<MySelect
								...
								onChange={(value) => {
									setAttr__({
										...panelData,
										stackOn: value as WCB_COUNTDOWN_PANEL_ICON["stackOn"],
									});
								}}
							/>
						)}
							...
							<MySelect
								...
								onChange={(value) => {
									setAttr__({
										...panelData,
										verticalAlignment:
											value as WCB_COUNTDOWN_PANEL_ICON["verticalAlignment"],
									});
								}}
							/>
						)}
