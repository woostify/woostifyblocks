...
export interface WCB_COUNTDOWN_PANEL_STYLE_ICON {
	color: string;
	hoverColor: string;
...
export const WCB_COUNTDOWN_PANEL_STYLE_ICON_DEMO: WCB_COUNTDOWN_PANEL_STYLE_ICON =
	{
		color: "#334155",
		hoverColor: "",
...
interface Props
	...
	panelData: WCB_COUNTDOWN_PANEL_STYLE_ICON;
	setAttr__: (data: WCB_COUNTDOWN_PANEL_STYLE_ICON) => void;
}

const WcbIconBoxPanel_StyleIcons: FC<Props> = ({
	panelData = WCB_COUNTDOWN_PANEL_STYLE_ICON_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
