...
export interface WCB_ICON_BOX_PANEL_IMAGES {
...
export const WCB_ICON_BOX_PANEL_IMAGES_DEMO: WCB_ICON_BOX_PANEL_IMAGES = {
...
interface Props
	...
	panelData: WCB_ICON_BOX_PANEL_IMAGES;
	setAttr__: (data: WCB_ICON_BOX_PANEL_IMAGES) => void;
}
...
const WcbTeamPanelImages: FC<Props> = ({
	...
	const renderSettingsImage = () => {
		const POSTION_PLANS: MyRadioItem<
			WCB_ICON_BOX_PANEL_IMAGES["imagePosition"]
		>[] = [
			{ name: "top", icon: "Top" },
			{ name: "left", icon: "Left" },
		...
		const STACKON_PLANS: MyRadioItem<WCB_ICON_BOX_PANEL_IMAGES["stackOn"]>[] = [
			{ name: "none", icon: "None" },
			{ name: "tablet", icon: "Tablet" },
			{ name: "mobile", icon: "Mobile" },
		];
		const ALIGNSELF_PLANS: MyRadioItem<
			WCB_ICON_BOX_PANEL_IMAGES["imageAlignSelf"]
		>[] = [
