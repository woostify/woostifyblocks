...
export interface WCB_ICON_BOX_PANEL_STYLE_IMAGE {
	margin: HasResponsive<DimensionSettings>;
	imageSize: HasResponsive<string>;
	border: MyBorderControlData;
}
export const WCB_ICON_BOX_PANEL_STYLE_IMAGE_DEMO: WCB_ICON_BOX_PANEL_STYLE_IMAGE =
	{
		margin: {
			Desktop: {
				top: "1rem",
...
interface Props
	...
	panelData: WCB_ICON_BOX_PANEL_STYLE_IMAGE;
	setAttr__: (data: WCB_ICON_BOX_PANEL_STYLE_IMAGE) => void;
}
