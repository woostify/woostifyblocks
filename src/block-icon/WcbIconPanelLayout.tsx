...
export interface WCB_ICON_PANEL_LAYOUT {
...
export const WCB_ICON_PANEL_LAYOUT_PRESET_LEFT_DEMO: WCB_ICON_PANEL_LAYOUT = {
	textAlignment: { Desktop: "left" },
	contentWidth: { Desktop: "100%" },
	flexDirection: { Desktop: "column" },
};
export const WCB_ICON_PANEL_LAYOUT_PRESET_CENTER_DEMO: WCB_ICON_PANEL_LAYOUT = {
	textAlignment: { Desktop: "center" },
	contentWidth: { Desktop: "100%" },
	flexDirection: { Desktop: "column" },
};

export const WCB_ICON_PANEL_LAYOUT_DEMO: WCB_ICON_PANEL_LAYOUT = {
	textAlignment: { Desktop: "center" },
	contentWidth: { Desktop: "100%" },
...
interface Props
	...
	panelData: WCB_ICON_PANEL_LAYOUT;
	setAttr__: (data: WCB_ICON_PANEL_LAYOUT) => void;
}

const WcbIconPanelLayout: FC<Props> = ({
...
export default WcbIconPanelLayout;
