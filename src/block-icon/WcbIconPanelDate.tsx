...
export interface WCB_ICON_PANEL_DATE {
	enableLabel: boolean;
	date: icon_date;
	show_day: boolean;
	show_hour: boolean;
...
export const WCB_ICON_PANEL_DATE_DEMO: WCB_ICON_PANEL_DATE = {
	enableLabel: true,
...
interface Props
	...
	panelData: WCB_ICON_PANEL_DATE;
	setAttr__: (data: WCB_ICON_PANEL_DATE) => void;
}

const WcbIconPanelDate: FC<Props> = ({
	panelData = WCB_ICON_PANEL_DATE_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
...
export default WcbIconPanelDate;
